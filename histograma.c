...
/*
  for(i=0;i<=255;i++)
  {
    for(k=0;k<Img1->size;k++)
      if (((unsigned int)Img1->imx[k])==i)
        contador++;
    H[i]=contador;
    contador=0;
  }*/
...
//Forma mas rapida
  ...
  gcPutImgBmp("EjemploHistograma.bmp",Img1);
